...
Type: Core paper example

Mathematical definition: Small coordinate shift crosses the terminal failure boundary.

Expected behavior: Operational OT should detect harm even when geometry is small.
