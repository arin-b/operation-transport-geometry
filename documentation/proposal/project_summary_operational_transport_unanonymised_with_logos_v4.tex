...
\newcommand{\IISCLogo}{\includegraphics[height=1.45cm]{assets/small_iisc_logo.png}}
\newcommand{\RBCCPSLogo}{\includegraphics[height=1.35cm]{assets/small_rbccps_logo.png}}
\begin{document}
\twocolumn[{%
\begin{center}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.96\textwidth]{assets/small_framework_diagram.png}
    \caption{Schematic overview of the proposed framework. A finite computational DAG induces domain-specific node representations, which are aligned through projections into a shared node representation space equipped with operational geometry. Terminal operational evaluation induces node-wise risk, which shapes both the admissible coupling structure and the operational transport geometry used to compare or adapt domain-induced node distributions.}
    \label{fig:framework}
\end{figure*}
